...
public class IndexController {
    ...
    public String  hello(Model model){
        ...
        //宠物狗推荐
        model.addAttribute("PetsRecommend",goodsService.queryDiffRecommendByType(8));
        //宠物粮食推荐
        model.addAttribute("PetsFood",goodsService.queryDiffRecommendByType(11));
        //宠物玩具推荐
        model.addAttribute("PetsToys",goodsService.queryDiffRecommendByType(12));
        //轮播图
